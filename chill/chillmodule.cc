...
// here add the python interface for the sample function we defined
static PyObject* chill_testFunction(PyObject* self, PyObject* args) {

   strict_arg_num(args, 0);
   myloop->testFunction() ; 
   Py_RETURN_NONE;
...
static PyObject* chill_dTile(PyObject* self, PyObject* args){
